  ...
  return (
    <React.StrictMode>
      <Provider store={store}>
        <div
          style={appScale}
          className="cursor-inactive flex flex-col-reverse md:flex-col w-screen min-h-screen select-none font-sigmar bg-gradient-to-b from-purple-800 via-purple-900 to-violet-950 overflow-y-auto overflow-x-hidden">
