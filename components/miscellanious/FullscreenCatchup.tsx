...
export default function FullscreenCatchup() {
  ...
  const progressPercentage = delta > 0 ? (deltaProcessed / delta) * 100 : 0
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900">
      <div className="flex w-full max-w-2xl flex-col items-center gap-8 px-8">
        {/* Title */}
        <h1 className="text-center text-4xl font-bold text-green-400 md:text-6xl">Catching Up...</h1>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <h2 className="font-passion text-frost">Processing lost minutes</h2>
          <div className="flex w-64 justify-between font-passion text-sm text-gray-400">
        ...
        <div>
          <button
            className="h-20 w-40 rounded-lg border-2 border-frost bg-red-500 p-4 font-passion text-lg text-frost hover:cursor-active"
            onClick={() => {}}>
            Stop (to do)
          </button>
        </div>
