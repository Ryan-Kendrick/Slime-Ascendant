...
export default function FullscreenCatchup() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-auto bg-slate-900 p-2 font-passion">
      <div className="flex w-full max-w-2xl flex-col items-center gap-4 px-8">
        <h1 className="text-center font-sigmar text-5xl font-bold text-green-400 sm:text-6xl">Catching Up...</h1>
        <p className="text-center font-sigmar text-2xl text-green-500">{flavourText}</p>
        ...
        <div className="flex flex-col items-center gap-4 text-frost">
          ...
          <div className="flex flex-col items-center rounded rounded-lg border-2 border-gray-200 bg-black/30 px-3 py-2 shadow shadow-green-500">
            <h2 className="text-lg text-gray-300">Catching up on {minutesRemaining} minutes</h2>
        ...
        <div className="flex flex-col items-center gap-4 text-frost">
          ...
          <button
            className="h-16 w-40 rounded-lg border-2 border-frost bg-emerald-700 p-4 font-passion text-xl text-frost hover:cursor-active hover:bg-emerald-600"
            onClick={() => {
