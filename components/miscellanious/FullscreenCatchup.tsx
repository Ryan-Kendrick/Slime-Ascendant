  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-auto bg-slate-900 p-2 font-passion">
      <div className="flex w-full max-w-2xl flex-col items-center gap-8 px-8">
        ...
        <div className="flex flex-col items-center gap-1 text-frost">
          ...
          <h3 className="font-passion">
            ...
            <span
              className={clsx(
                "font-sigmar",
                zoneState.stageNumber + 1 === zoneState.currentZoneLength ? "text-red-400" : "text-white",
              )}>
              {monster.name}
            </span>{" "}
            at Stage {zoneState.stageNumber + 1} of Zone {zoneState.currentZoneNumber}
          </h3>
        </div>
        ...
        <div>
          <button
            className="h-16 w-40 rounded-lg border-2 border-frost bg-red-500 p-4 font-passion text-xl text-frost hover:cursor-active"
            onClick={() => {
